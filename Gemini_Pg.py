...
def save_conversation(conversation: str) -> str:
    with open(
        f"./GEMINI_CHATS/{SESSION_TIMESTAMP}_{MODEL}_Chat.md", "w+", encoding="utf-8"
    ) as file:
...
user_settings_prompt = (
    "[bold blue]Insert name and preferences:[/bold blue]\n"
...
SYSTEM_INSTRUCTION: str = (
    "You are a helpful assistant and this is valuable information \
    about the user interacting with you: "
    + USER_SETTINGS
)
# =================================================================

config = types.GenerateContentConfig(system_instruction=USER_SETTINGS, temperature=0.0)
